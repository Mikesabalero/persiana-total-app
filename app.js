...
// renderClientDatalist, searchClientsAPI, setupClientSearch, syncClientSelect → js/modules/clientes/clientes.js
// calcPrecioVentaComp → js/modules/precios/precios.js
...
// loadPrecios, updateTcFromPrecios, nuevoComponente, openModalEditComp, saveComponent,
// deleteComponent, filterComp, sortCompTable, exportCsv → js/modules/precios/precios.js

// renderClientes → js/modules/clientes/clientes.js
// renderPropiedades → js/modules/propiedades/propiedades.js
// renderPropiedades, filterSelectOptions, filterPropiedades, filterCli → js/modules/ (clientes, propiedades)
function filterPresupuestos() {
    PAGING.presupuestos.page = 1;
    loadPresupuestos();
}
// showClientDetail, viewCliente → js/modules/clientes/
...
// openNewCliente, closeModalCliente, saveCliente, deleteCliente → js/modules/clientes/clientes.js

// openNewPropiedad, closeModalPropiedad, savePropiedad, deletePropiedad → js/modules/propiedades/propiedades.js
...
// aplicarAumento, toggleAumentoModo, loadHistorialPrecios → js/modules/precios/aumentos.js
...
// ============================================================
// --- Funciones de Fase 4 migradas a main.js ---
// (clientes, propiedades, precios, aumentos → expuestas en window desde main.js)

// --- Funciones de presupuestos que aún están en app.js (Fase 5 las migrará) ---
